...
:: Orianna
%BIN_IMPORT_TEXTURE% data/entities/oriana/model/h_03_wa__oriana_d01.tga data/entities/oriana/model/h_03_wa__oriana_d01.xbm CharacterDiffuse
%BIN_IMPORT_TEXTURE% data/entities/oriana/model/h_03_wa__oriana_n01.tga data/entities/oriana/model/h_03_wa__oriana_n01.xbm NormalmapGloss
